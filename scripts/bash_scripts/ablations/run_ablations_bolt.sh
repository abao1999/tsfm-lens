...
model_dirname="chronos_bolt"

model_name="amazon/chronos-bolt-${chronos_model_size}"
...
for ablation_types in "${ablation_types_lst[@]}"; do
    for layer_group_size in "${n_consecutive_layers_to_ablate_lst[@]}"; do
        ...
        python scripts/run_ablations.py \
            ...
            eval.batch_size=32 \
            eval.results_save_dir=$STOR/results \
