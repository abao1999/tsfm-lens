...
dataset_name=base40
data_dir=/ssd2/data/$dataset_name
...
python scripts/logit_attribution.py \
    ...
    eval.batch_size=4 \
    eval.results_save_dir=/ssd2/logit_attribution \
    eval.metrics_save_dir=/ssd2/logit_attribution_results/${model_dirname}/${model_name} \
